		...
		if($('#reportsSelect').find('option').length == 1){
			$.ajax({
				...
				success: function(data){  
					...
					$('#reportsSelect').append('<option value="34534534">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc a purus mauris. Ut gravida tempor metus ultricies scelerisque. Aenean nec diam lorem, et interdum augue. Cras sit amet posuere tortor.</option>');
					$('#reportsSelect').append('<option value="34534534">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc a purus mauris. Ut gravida tempor metus ultricies scelerisque. Aenean nec diam lorem, et interdum augue. Cras sit amet posuere tortor.</option>');
					$('#reportsSelect').append('<option value="34534534">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc a purus mauris. Ut gravida tempor metus ultricies scelerisque. Aenean nec diam lorem, et interdum augue. Cras sit amet posuere tortor.</option>');
					$('#reportsSelect').append('<option value="34534534">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc a purus mauris. Ut gravida tempor metus ultricies scelerisque. Aenean nec diam lorem, et interdum augue. Cras sit amet posuere tortor.</option>');
					$('#reportsSelect').append('<option value="34534534">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc a purus mauris. Ut gravida tempor metus ultricies scelerisque. Aenean nec diam lorem, et interdum augue. Cras sit amet posuere tortor.</option>');
